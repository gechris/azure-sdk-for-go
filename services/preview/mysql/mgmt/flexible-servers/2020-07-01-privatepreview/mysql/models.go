...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/mysql/mgmt/flexible-servers/2020-07-01-privatepreview/mysql"
    ...
    return err
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysql.ConfigurationsUpdateFuture", "Result", future.Response(), "Polling failure")
        return
        }
        if !done {
        err = azure.NewAsyncOpIncompleteError("mysql.ConfigurationsUpdateFuture")
        return
        }
            ...
            if err != nil {
            err = autorest.NewErrorWithError(err, "mysql.ConfigurationsUpdateFuture", "Result", c.Response.Response, "Failure responding to request")
            }
            }
            return
        }
    ...
    return err
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysql.MaintenanceWindowsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
        return
        }
        if !done {
        err = azure.NewAsyncOpIncompleteError("mysql.MaintenanceWindowsCreateOrUpdateFuture")
        return
        }
            sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
            ...
            if err != nil {
            err = autorest.NewErrorWithError(err, "mysql.MaintenanceWindowsCreateOrUpdateFuture", "Result", mw.Response.Response, "Failure responding to request")
            }
            }
            return
        }
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysql.MaintenanceWindowsDeleteFuture", "Result", future.Response(), "Polling failure")
        return
        }
        if !done {
        err = azure.NewAsyncOpIncompleteError("mysql.MaintenanceWindowsDeleteFuture")
        return
        }
            ar.Response = future.Response()
        return
