...
func (client MaintenanceWindowsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, serverName string, maintenanceWindowName string, parameters MaintenanceWindow) (result MaintenanceWindowsCreateOrUpdateFuture, err error) {
    if tracing.IsEnabled() {
        ...
        return result, validation.NewError("mysqlflexibleservers.MaintenanceWindowsClient", "CreateOrUpdate", err.Error())
        }

        req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, serverName, maintenanceWindowName, parameters)
    if err != nil {
    err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "CreateOrUpdate", nil , "Failure preparing request")
    return
    }

        result, err = client.CreateOrUpdateSender(req)
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
        return
        }
...
func (client MaintenanceWindowsClient) Delete(ctx context.Context, resourceGroupName string, serverName string, maintenanceWindowName string) (result MaintenanceWindowsDeleteFuture, err error) {
    if tracing.IsEnabled() {
        ...
        return result, validation.NewError("mysqlflexibleservers.MaintenanceWindowsClient", "Delete", err.Error())
        }

        req, err := client.DeletePreparer(ctx, resourceGroupName, serverName, maintenanceWindowName)
    if err != nil {
    err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "Delete", nil , "Failure preparing request")
    return
    }

        result, err = client.DeleteSender(req)
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "Delete", result.Response(), "Failure sending request")
        return
        }
    ...
    if tracing.IsEnabled() {
        ...
        { TargetValue: resourceGroupName,
         Constraints: []validation.Constraint{	{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil },
        	{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil },
        	{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil }}}}); err != nil {
        return result, validation.NewError("mysqlflexibleservers.MaintenanceWindowsClient", "Get", err.Error())
        }

        req, err := client.GetPreparer(ctx, resourceGroupName, serverName, maintenanceWindowName)
    if err != nil {
    err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "Get", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "Get", resp, "Failure sending request")
        return
        }

        result, err = client.GetResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "Get", resp, "Failure responding to request")
        }
    ...
    if tracing.IsEnabled() {
        ...
        { TargetValue: resourceGroupName,
         Constraints: []validation.Constraint{	{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil },
        	{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil },
        	{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil }}}}); err != nil {
        return result, validation.NewError("mysqlflexibleservers.MaintenanceWindowsClient", "ListByServer", err.Error())
        }

            result.fn = client.listByServerNextResults
    req, err := client.ListByServerPreparer(ctx, resourceGroupName, serverName)
    if err != nil {
    err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "ListByServer", nil , "Failure preparing request")
    return
    }
        ...
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "ListByServer", resp, "Failure sending request")
        return
        }

        result.mwlr, err = client.ListByServerResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "ListByServer", resp, "Failure responding to request")
        }
...
autorest.WithQueryParameters(queryParameters))
    ...
    func (client MaintenanceWindowsClient) ListByServerResponder(resp *http.Response) (result MaintenanceWindowListResult, err error) {
            ...
            if err != nil {
            return result, autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "listByServerNextResults", nil , "Failure preparing next results request")
            }
            if req == nil {
            return
            }
            ...
            if err != nil {
            result.Response = autorest.Response{Response: resp}
            return result, autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "listByServerNextResults", resp, "Failure sending next results request")
            }
            result, err = client.ListByServerResponder(resp)
            if err != nil {
            err = autorest.NewErrorWithError(err, "mysqlflexibleservers.MaintenanceWindowsClient", "listByServerNextResults", resp, "Failure responding to next results request")
            }
            return
                    }
